          ...
          Container(
            ...
            child: DataTable2(
              ...
              columns: [
                ...
                DataColumn(label: Text('Reveiver/s')),
              ...
              rows: List<DataRow>.generate(
                ...
                (index) => DataRow(
                  cells: [
                    ...
                    DataCell(CustomText(text: 'Single/Group')),
                    DataCell(CustomText(text: 'Receiver/s')),
                    DataCell(CustomText(text: '1h52min')),
                    DataCell(CustomText(text: 'Brazil')),
                    DataCell(CustomText(text: 'In course/Ended')),
                    DataCell(CustomText(text: '$index')),
                    DataCell(Row(
                      children: [
                        Container(
